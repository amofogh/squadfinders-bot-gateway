...
const Dashboard = (props) => {
    ...
    const timeButtons = [
        {label: '5m', value: '5m'}, {label: '10m', value: '10m'}, {
            label: '15m',
            value: '15m'
        },
        ...
        return React.createElement('div', {
            ...
            React.createElement('div', {key: 'loader'}, [
                ...
                React.createElement('h2', {
                    key: 'text',
                    style: {color: LIGHT_THEME.textSecondary, margin: 0}
                }, 'Loading Dashboard...')
            ])
        ]);
    }
        ...
        return React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                React.createElement('p', {
                    key: 'message',
                    style: {margin: 0, color: LIGHT_THEME.textSecondary}
                }, error)
            ])
        ]);
    }
    ...
    return React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                autoRefresh && React.createElement('select', {
                    ...
                    style: {
                        padding: '6px 10px',
                        borderRadius: '4px',
                        border: `1px solid ${LIGHT_THEME.inputBorder}`,
                        background: LIGHT_THEME.inputBackground,
                        color: LIGHT_THEME.textPrimary,
                        fontSize: '14px'
                    }
        ...
        React.createElement('div', {
            ...
            React.createElement(StatBox, {
                key: 'processingMessages',
                title: 'Processing Messages',
                value: stats?.processingMessages || 0,
                color: '#6bcf7f',
                icon: '⚙️'
            }),
            React.createElement(StatBox, {
                key: 'completedMessages',
                title: 'Completed Messages',
                value: stats?.completedMessages || 0,
                color: '#4d96ff',
                icon: '✅'
            }),
            React.createElement(StatBox, {
            ...
            React.createElement(StatBox, {
                ...
                value: stats?.expiredMessages || 0,
                color: '#a8a8a8',
                icon: '⏰'
            }),
            React.createElement(StatBox, {
                key: 'canceledByUserMessages',
                title: 'Canceled by User',
                value: stats?.canceledByUserMessages || 0,
                color: '#ffa94d',
                icon: '🚫'
            }),
            React.createElement(StatBox, {
...
const NavCard = ({href, label, description, icon, active = false}) => {
    ...
    return React.createElement('a', {
        ...
        React.createElement('div', {
            key: 'description',
            style: {fontSize: '13px', color: LIGHT_THEME.textSecondary}
        }, description)
    ]);
};
